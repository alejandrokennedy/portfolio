        ...
        <Grid>
          <Grid.Col span={{ base: 12, sm: 4 }}>
            <div style={{position: 'sticky', top: '75px'}}>
              This visualization was published in People Magazine during the Covid-19 Pandemic. The original article can be viewed <Anchor href='https://people.com/health/see-how-the-highly-contagious-coronavirus-spread-across-the-us/' underline="hover">here</Anchor>. The People.com page unfortunately no longer loads the visualization.
            </div>
          </Grid.Col>
